This project is forked from https://github.com/Arkq/bluez-alsa (thanks for their generosity). It aims to make a Bluetooth Sound Box on RaspberryPi.
You can build your bluealsa follow steps below, and start your bluealsa by using scripts under "script directory".
